...
## Model test config
# SELECTED_MODEL_TEST_CONFIG="Generalized_TOW_Oneclass_PrunedCNNIDS_test.json"
# SELECTED_MODEL_TEST_CONFIG="AVTP_Oneclass_test.json"
SELECTED_MODEL_TEST_CONFIG="AVTP_Oneclass_RandomForest.json"
