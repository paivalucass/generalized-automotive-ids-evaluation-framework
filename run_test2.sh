...
venv/bin/python3 feature_generator/cnn_ids_filter.py#!/bin/bash
...
SELECTED_MODEL_TRAIN_VALIDATE_CONFIG="TOW_filtered_PrunedCNNIDS_OneClass_train.json"
# SELECTED_MODEL_TRAIN_VALIDATE_CONFIG="TOW_CNNIDS_Oneclass_train.json"

## Model test config
# SELECTED_MODEL_TEST_CONFIG="AVTP_RandomForest_test.json"
# SELECTED_MODEL_TEST_CONFIG="AVTP_PrunedCNNIDS_test.json"
# SELECTED_MODEL_TEST_CONFIG="TOW_Oneclass_PrunedCNNIDS_test.json"
# SELECTED_MODEL_TEST_CONFIG="TOW_RandomForest_test.json"
# SELECTED_MODEL_TEST_CONFIG="Generalized_TOW_Oneclass_PrunedCNNIDS_Indoor_test.json"
SELECTED_MODEL_TEST_CONFIG="Generalized_TOW_masked_Oneclass_PrunedCNNIDS_Driving_test.json"
